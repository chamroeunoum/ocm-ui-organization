  ...
  setup(props){
    ...
    function setActiveMenu( menu ){
      ...
      activeMenu.value = menu == undefined || menu == null || menu == ''
        ? 'profile'
        : menu
      showBackgroundInformationPanel.value = showRewardsPanel.value = showOrgposPanel.value = showSalaryRangePanel.value = showProfilePanel.value = showEducationPanel.value = showBirthCertificatePanel.value = showWeddingCertificatePanel.value = showNicPanel.value = showPassportPanel.value = false
      switch( menu ){
        case 'educations' : 
