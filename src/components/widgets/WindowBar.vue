<template>
    <div class="fixed left-0 top-0 right-0 bg-white flex title-bar border-b border-gray-200 px-2 py-1">
      <div class="flex w-64 h-6 title " >
        <div v-html="icons[icon]" ></div>
        <div class="font-moul ml-2 leading-6 text-xxs " v-html="title" ></div>
      </div>
