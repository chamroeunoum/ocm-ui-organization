<template>
  ...
  <n-modal v-model:show="toggleAbout" class="bg-white rounded" :block-scroll="false" >
    <div v-if="toggleAbout" class="relative about-us p-16 pb-20" >
      ...
      <div class="w-full text-center font-moul leading-9 text-xs" >{{ systemName }}<br/>អភិវឌ្ឍន៍ដោយក្រុមការងារ<br/>នៃ<br/>នាយកដ្ឋានឯកសារអេឡិចត្រូនិច និងព័ត៌មានវិទ្យា<br/>កំណែប្រែ ១.០</div>        
